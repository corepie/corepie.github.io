...
/**
 * Servlet implementation class delcaiwu
 */
@WebServlet("/delcaiwu.do")
public class delcaiwu
extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql ="delete from 明细表 where 流水号 = CONVERT(nvarchar,'" + cid +"');";
			Boolean flag = statement.execute(sql);
			String UTF_8text1 = "guahao";
			response.sendRedirect("/"+new String(UTF_8text1.getBytes("utf-8"),"iso-8859-1")+"/administrator/caiwu/caiwu.jsp");
