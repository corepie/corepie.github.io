...
/**
 * Servlet implementation class delyaopin
 */
@WebServlet("/delyaopin.do")
public class delyaopin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String sql ="delete from 药品表 where 药品号码 = CONVERT(nvarchar,'" + tid +"');";
