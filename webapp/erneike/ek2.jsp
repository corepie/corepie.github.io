...
<ul class="nav">
 ...
 <li><a href="../homepage/menu.jsp">主页</a></li>
  ...
  <li class="active"><a href="../erneike/erneike.jsp">儿内科</a></li>
...
z-index: 99999;">
    ...
    ">
        ...
        <!-- 内容 -->
        <form  action="/guahao/outcall4.do" method="post">
...
try{
	...
	while (rs2.next()){
		...
		out.println("<tr><td>"+ygname2+"</td><td>"+ygsex+"</td><td>"+zhicheng+"</td><td>"+cost+"</td><td>"+yuhao
				+"</td>");%>
				<td class="quchu"><a href='../erneike/ek2.jsp?ygname=<%=ygname %>'>选择</a></td>
				</tr>
	<%}
}catch (ClassNotFoundException e){
	out.print("类没有找到异常：");
