...
z-index: 99999;">
    <!-- 创建主窗口 -->
    <div class="zongti" style="position: fixed;
    top: 50%;
    left: 50%;
    width: 60%;
    max-width: 500px;
    ...
    ">
        <!-- 标题 -->
        <h4 style="font-weight: bold;text-align:center;font-size: 25px;">就医须知</h4>
        <!-- 内容 -->
        <div style="font-size: 16px;margin-top: 26px;line-height: 30px;color: #090808;">
        各位病友：<br>
        感谢您选择来我院就诊，为保证您顺利就诊，请认真阅读并充分理解以下规则：<br>
        一、重点提醒<br>
        ◆建议您来院时规范佩戴口罩，做好个人防护。<br>
        ◆发热患者请前往发热门诊就诊。<br>
        二、就医规则<br>
        1、实名制预约：<br>
        桂医附院需要您提供姓名、有效身份证件号码、有效手机号码等信息。<br>
        2、预约时间：<br>
        预约提前一周开放，每日0点开放到第8日号源。<br>
        3、预约签到：<br>
        使用微信扫描诊区屏幕二维码进行签到候诊。<br>
         3、预约迟到：<br>
        请您根据预约时间提前到院签到，未按时者需退号后重新预约。<br>
        </div>
        <!-- 按钮 -->
        ...
        <script>
           ...
           var zt = document.querySelector(".zongti");
        	    var timer = null;
        	    var num = 2;
        	    ...
        	    var timer = setInterval(function() {
        	     ...
        	     btn.onclick = function(){
        	    	 location.href = 'http://localhost:8080/guahao/homepage/menu.jsp';
        	     }
        	     //num = 5;
        	      }  
        	       else {
        	    	 btn.disabled=true;   //设置成不能选取的状态
        	         btn.innerHTML = '我知道了&nbsp;&nbsp;'+num + '秒';
